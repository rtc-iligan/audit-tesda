            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                           <h5>
                                <i class="fa-solid fa-bars"></i>&nbsp;{{ __('Assessment Center Management') }}
                           </h5>
                        </div>
                        <div class="col-6">
                ...
                <div class="card-body">
                        <table class="table table-striped table-hover border">
                            <thead>
                                <tr>
                                <th scope="col">#</th>
                                <th scope="col">Assessment Center</th>
                                <th scope="col">Abbreviation</th>
                                <th scope="col">AC Manager</th>
                                <th scope="col" width="5%">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($center as $i => $center)
                                <tr>
                                <td>{{ ++ $i }}</td>
                                <td>{{ $center->tvi_name }}</td>
                                <td>{{ $center->tvi_abrv}}</td>
                                <td>{{ $center->tvi_manager }}</td>
                                <td>
                                    <div class="dropdown">
